<div class="well accepted-papers">
	...
	<h4>Prevalent Systems: A Pattern Language</h4>
	...
	<h4>A pattern for a secure and safe port loading facility</h4>
	...
	<h4>Change Cipher Specification Message Drop Attack: A Misuse Pattern for the SSL/TLS Server Authentication Handshake Protocol</h4>
	...
	<h4>The Last Two TestDriven Development Step Patterns: Bug Locator and Pause for Housekeeping</h4>
	...
	<h4>A Pattern to Argue the Compliance of System Safety Requirements Decomposition</h4>
	...
	<h4>Padrões para Criação de Objetos de Aprendizagem</h4>
	...
	<h4>Partial View: Um padrão para reutilização de views na arquitetura MVC</h4>
	...
	<h4>QA to AQ Part Three - Shifting from Quality Assurance to Agile Quality: "Tearing Down the Walls"</h4>
	...
	<h4>Presentation Patterns: A Pattern Language for Creative Presentations, Part I</h4>
	...
	<h4>Mining Interview Patterns: Patterns for Effectively Obtaining Seeds of Patterns</h4>
	...
	<h4>Personal Picture Method for Self Design</h4>
	...
	<h4>Um Estudo Exploratório da Arquitetura e Projeto de Aplicativos Android</h4>
	...
	<h4>OWSE-AF: Um Framework para Desenvolvimento de Aplicações Web</h4>
	...
	<h4>Gerência de Variabilidades na Plataforma Android</h4>
	...
	<h4>Padrões para desenvolvimento de software em startups</h4> 
	<h5>Jorge A. Melegati, Gonçalves Alfredo Goldman</h5>
	
	<p>As startups de tecnologia estão presentes no cenário da inovação e da economia de maneira geral desde a década de 1970. Entretanto, de forma análoga às metodologias ágeis, as suas melhores práticas estão sendo discutidas no campo científico após já estarem em uso na indústria, invertendo o caminho natural da pesquisa científica e sua aplicação na indústria. Na realidade, a busca por melhores práticas no desenvolvimento de startups se deu após a crise chamada "bolha ponto com", no início dos anos 2000 que levou diversas empresas a fecharem e à diminuição dos investimentos no setor. Este conjunto de padrões tem como objetivo sistematizar diversas práticas descritas na literatura, especificamente, no desenvolvimento de software dentro das startups visando a melhoria dos processos e dos produtos dessas empresas. Na nossa lista, usamos uma classificação, proposta por Paternoster [3] em seu mapeamento sistemático sobre desenvolvimento de software em startups, dos padrões segundo as seguintes categorias: gerências de processos, práticas de desenvolvimento de software (subdividada em engenharia de requisitos; design e arquitetura; implementação, manutenção e deploy; controle de qualidade), práticas organizacionais e de governança e ferramentas e tecnologia.</p>
	
	<h4>The Dynamic Relations Pattern</h4>
